...
<a href="adminsubmission.php">Submission</a> 
...
<h2 align="center"> Submission Details</h2>
...
<body>
   <table width='100%' border=1 style="font-size:12px;">
    ...
    <tr>
         <th>Name</th> <th>Designation</th> <th>Department</th><th>University</th> <th>Article</th>  <th>Article type</th><th>Author</th><th >File Name</th><th >Status</th><th >Submission Id</th><th>Download File</th><th>Update Status</th>
    </tr>
	
	
		
	<?php
		$conn=new PDO('mysql:host=localhost; dbname=rsa_db', 'root', '') or die(mysql_error());	$query=$conn->query("select * from papersubmission ORDER BY id asc");
			...
			<tr>
				...
				<td>
					&nbsp;<?php echo $suffix ;?>.&nbsp;<?php echo $name ;?></td>
				...
				<td>
					<button class="alert-success"><a href="viewdownload.php?filename=<?php echo $file;?>&f=<?php echo $row['file'] ?>">Download</a></button></td>
					
					
					<td>
					
					<button class="alert-success"><a href="edit.php?id=<?php echo $row['id'] ?>">Update</a></button>
