...
<a href="about.html">User details</a>              
<a href="editor.html">Submission</a> 
...
<body>
   <table width='100%' border=1>
    ...
    <tr>
        <th>Suffix</th> <th>Name</th> <th>Designation</th> <th>Department</th><th>University</th> <th>Article</th>  <th>Article type</th><th>Author</th><th >File Name</th><th >Action</th>
    </tr>
		
	<?php
		$conn=new PDO('mysql:host=localhost; dbname=rsa_db', 'root', '') or die(mysql_error());	$query=$conn->query("select * from papersubmission order by name desc");
			...
			<tr>
				...
				<td>
					<button class="alert-success"><a href="viewdownload.php?filename=<?php echo $file;?>&f=<?php echo $row['file'] ?>">Download</a></button>
				</td>
			</tr>
			<?php }?>
		</table>
