...
<h2 align="center"> Update Submission Details</h2>
...
{	
	...
	// update user data
	$result = mysqli_query($mysqli, "UPDATE papersubmission SET name='$name',status='$status' WHERE id=$id");
	
	// Redirect to homepage to display updated user in list
	header("Location: adminsubmission.php");
}
?>
<?php
...
while($user_data = mysqli_fetch_array($result))
{
	...
	$submissionid = $user_data['submissionid'];
}
?>
<html>
<head>	
...
<body>
	...
	<form name="update_user" method="post" action="edit.php">
		...
		<tr> 
				<td>Submission Id</td>
				<td><input type="text" name="name" value=<?php echo $submissionid;?> readonly=""></td>
			</tr>
			<tr> 
				<td>Name</td>
