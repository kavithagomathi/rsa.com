...
<a style="width:300px;" href="checkid1.php">Check Submission</a> 
...
<h2 align="center">Check Submission</h2>
...
<body>
    <div class="wrapper" style="width:690px;"  >
            ...
            <form action="checkid2.php" method="GET">
		
              
                <div class="form-field">
                    <input type="text" name="stud_id" placeholder="Enter Your ID"  value="<?php if(isset($_GET['stud_id'])){echo $_GET['stud_id'];} ?>" class="form-control">
                </div>
